<template>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${CONTEXT_PATH}/res/img/profile_small.jpg" /></span>
                ...
                <li>
                    <a class="J_menuItem" href="${CONTEXT_PATH}/agile-board"><i class="fa fa-columns"></i> <span class="nav-label">任务白板</span></a>
                </li>
                <li>
                    <a class="J_menuItem" href="${CONTEXT_PATH}/project"><i class="fa fa-inbox"></i> <span class="nav-label">项目</span></a>
                </li>
                <li>
                    <a href="#">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${CONTEXT_PATH}/res/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${CONTEXT_PATH}/res/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
        ...
        <div class="row J_mainContent" id="content-main">
            <!--<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${CONTEXT_PATH}/main" frameborder="0" data-id="index_v1.html" seamless></iframe>-->
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${CONTEXT_PATH}/res/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${CONTEXT_PATH}/res/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${CONTEXT_PATH}/res/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${CONTEXT_PATH}/res/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${CONTEXT_PATH}/res/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${CONTEXT_PATH}/res/img/a7.jpg">
                                </div>
                                <div class="media-body">
